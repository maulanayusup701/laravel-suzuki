    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/dashboard"><img src="{{ asset('back-end/assets/compiled/svg/logo.svg') }}" alt="Logo" srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::is('dashboard/testimonial*') ? 'active' : '' }}">
                    <a href="/dashboard/testimonial" class='sidebar-link'>
                ...
                <li class="sidebar-item has-sub {{ Request::is('dashboard/information*') || Request::is('dashboard/user*') || Request::is('dashboard/carousell*') ? 'active' : '' }} ">
                    ...
                    <ul class="submenu submenu-closed" style="--submenu-height: 215px;">
                        ...
                        <li class="submenu-item {{ Request::is('dashboard/user*') ? 'active' : '' }}">
                            <a href="/dashboard/user" class="submenu-link">Account</a>
                        </li>
                    </ul>
                </li>
                <hr>
                <li class="sidebar-item">
                    <form action="/logout" method="POST">
                        @csrf
                        <button class='btn btn-danger btn-block' type="submit" onclick="return confirm('Apakah anda yakin ingin keluar?')">
